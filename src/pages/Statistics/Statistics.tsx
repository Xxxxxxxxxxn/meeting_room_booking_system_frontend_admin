...
export function Statistics() {
    ...
    async function getStatisticData(values: { startTime: string; endTime: string; }) {
        ...
        const startTime =values.startTime? dayjs(values.startTime).format('YYYY-MM-DD'):undefined;
        const endTime = values.endTime?dayjs(values.endTime).format('YYYY-MM-DD'):undefined;
